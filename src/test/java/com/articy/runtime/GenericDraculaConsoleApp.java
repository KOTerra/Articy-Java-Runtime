...
public class GenericDraculaConsoleApp {
    ...
    public static void main(String[] args) throws IOException {
        String archivePath = "exports/Articy-Dracula-Export-Generic.articygen";
        
        System.out.println("--- Articy Java Runtime: Interactive Generic Archive Test ---");
        
        // 1. Initialize Runtime From Archive
        ...
        db = ArticyRuntime.initializeFromArchive(archivePath, provider);
